...
import { columns } from "./column-purchase-order";
...
const statusCards = computed(() => {
  const map = {
    PENDING: {
      label: t("purchase_orders.card_title.padding"),
    ...
    APPROVED: {
      label: t("purchase_orders.card_title.success"),
      icon: "solar:clipboard-check-bold",
      textColor: "text-green-700",
      bgGradient: "bg-gradient-to-br from-green-200 via-green-300 to-green-400",
    },
    REJECTED: {
      label: t("purchase_orders.card_title.refused"),
...
const details = (id: string) => {
  push({ name: "approval_department_panak_detail", params: { id } });
};
          ...
          <div class="relative z-10">
            ...
            <div class="mt-2">
              <p class="text-xl font-semibold" :class="card.textColor">
                {{ card.count }} {{ t("purchase_orders.field.purchase_order") }}
              </p>
              <p
