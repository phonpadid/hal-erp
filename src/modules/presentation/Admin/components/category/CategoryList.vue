<template>
  <div class="category-list">
    ...
    <!-- Empty state -->
    <div v-else-if="categories.length === 0" class="bg-white p-8 text-center rounded-lg shadow">
      <svg
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="category in categories" :key="category.getId()" :class="{ 'bg-red-50': category.isDeleted() }">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <span
                :class="
                  category.isDeleted() ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                "
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              <div class="flex justify-end space-x-2">
                <template v-if="!category.isDeleted()">
                  <button
                    @click="$emit('edit', category.getId())"
                    class="text-indigo-600 hover:text-indigo-900"
                  >
                    Edit
                  </button>
                  <button
                    @click="confirmDelete(category.getId())"
                ...
                <template v-else>
                  <button
                    @click="$emit('restore', category.getId())"
...
import type { Category } from "@/modules/domain/entities/categories.entities";
